...
// Validation and error handling
    if (!isValid || !_isLogin && _selectedImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content:
              Text('Ensure credentials are correct and an image is uploaded.'),
        ),
      );
      return;
    }
...
// Login and Signup logic with Firebase
      if (_isLogin) {
...
// Additional logic for sign-up: image and Firestore entry
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                if (value == null ||
                                    value.isEmpty ||
                                    value.trim().length < 4) {
                                  return 'Enter a correct username with atleast 4 characters';
                                }
                                return null;
                              },
                              onSaved: (value) {
